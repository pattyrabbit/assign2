...
PImage fighterImg;
PImage hpImg;
PImage MoocsElementEnemy1Img;
PImage MoocsElementGainbombImg;
PImage start1Img;
PImage start2Img;
PImage treasureImg;
...
void setup () {
  ...
  MoocsElementEnemy1Img = loadImage("img/MoocsElementEnemy1.png");
  MoocsElementGainbombImg = loadImage("img/MoocsElementGainbomb.png");
